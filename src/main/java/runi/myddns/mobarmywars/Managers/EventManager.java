...
import runi.myddns.mobarmywars.Arena.ArenaScoreboardManager;
...
public class EventManager {
                ...
                if (countdown > 0) {
                    ...
                    new BukkitRunnable() {
                        ...
                        public void run() {
                            ...
                            WorldMessageManager.sendTitleToArenaWorlds(
    ...
    private void startEvent() {
        ...
        for (Player player : Bukkit.getOnlinePlayers()) {
            ...
            plugin.getEventResume().savePlayerSpawn(player, spawnLocation);
            ...
            plugin.getEventResume().startAutoSavePositions();
    ...
    public void resetGame(Player player) {
        ...
        ArenaScoreboardManager scoreboardManager = plugin.getArenaManager().getScoreboardManager();
