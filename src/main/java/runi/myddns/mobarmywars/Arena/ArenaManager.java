...
import runi.myddns.mobarmywars.Managers.BlockRandomizerManager;
import runi.myddns.mobarmywars.Managers.ResumeManager;
...
public class ArenaManager implements Listener {
    ...
    public void teleportTeamsToArena() {
        ...
        for (Player player : Bukkit.getOnlinePlayers()) {
            if (plugin.getTeamManager().getPlayerTeam(player) == null) continue;
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                if (countdown > 0) {
                    ...
                    WorldMessageManager.sendToArenaWorlds(msg);
                    WorldMessageManager.playSoundInArenaWorlds(
                            null,
                    ...
                    WorldMessageManager.sendToArenaWorlds(ChatColor.GREEN + "⚔ Das MobArmyWars beginnt!");
                    WorldMessageManager.playSoundInArenaWorlds(
                            null,
    ...
    public void showArenaSummary(Player player) {
        WorldMessageManager.sendToArenaWorlds(ChatColor.GOLD + "===== 📊 Auswertung Arena =====");

        int killsRot = scoreboardManager.getKillCount("Rot");
        int killsBlau = scoreboardManager.getKillCount("Blau");

        WorldMessageManager.sendToArenaWorlds(ChatColor.RED + "Team Rot Kills: " + killsRot);
        WorldMessageManager.sendToArenaWorlds(ChatColor.BLUE + "Team Blau Kills: " + killsBlau);

        WorldMessageManager.sendToArenaWorlds(ChatColor.GOLD + "===============================");
    }
